...
const (
	errNotIssue         = "managed resource is not a Issue custom resource"
...
func (e *externalClient) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	// TODO: Implement actual observation logic for Issue
...
func (e *externalClient) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	...
	// TODO: Implement creation logic for Issue
	externalID := cr.GetName()
	meta.SetExternalName(cr, externalID)

	return managed.ExternalCreation{}, errors.New("Issue controller not yet fully implemented")
}
...
func (e *externalClient) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	...
	// TODO: Implement update logic for Issue
	return managed.ExternalUpdate{}, errors.New("Issue controller not yet fully implemented")
}
...
func (e *externalClient) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	...
	// TODO: Implement deletion logic for Issue
	return managed.ExternalDelete{}, errors.New("Issue controller not yet fully implemented")
}
