...
const (
	...
	errGetOrganizationMember         = "failed to get organizationmember"
	errCreateOrganizationMember      = "failed to create organizationmember"
	errUpdateOrganizationMember      = "failed to update organizationmember"
	errDeleteOrganizationMember      = "failed to delete organizationmember"
