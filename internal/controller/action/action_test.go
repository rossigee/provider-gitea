...
import (
	...
	v1alpha1 "github.com/rossigee/provider-gitea/apis/action/v1alpha1"
...
func (m *MockClient) CreateOrganizationSecret(ctx context.Context, org, secretName string, req *clients.CreateOrganizationSecretRequest) error {
	return nil
}
func (m *MockClient) UpdateOrganizationSecret(ctx context.Context, org, secretName string, req *clients.CreateOrganizationSecretRequest) error {
	return nil
}
...
func (m *MockClient) GetAccessToken(ctx context.Context, username string, tokenID int64) (*clients.AccessToken, error) {
	return nil, nil
}
...
func (m *MockClient) UpdateAccessToken(ctx context.Context, username string, tokenID int64, req *clients.UpdateAccessTokenRequest) (*clients.AccessToken, error) {
	return nil, nil
}
func (m *MockClient) DeleteAccessToken(ctx context.Context, username string, tokenID int64) error {
	return nil
}
func (m *MockClient) GetRepositorySecret(ctx context.Context, repository, secretName string) (*clients.RepositorySecret, error) {
	return nil, nil
}
func (m *MockClient) CreateRepositorySecret(ctx context.Context, repository, secretName string, req *clients.CreateRepositorySecretRequest) error {
	return nil
}
func (m *MockClient) UpdateRepositorySecret(ctx context.Context, repository, secretName string, req *clients.UpdateRepositorySecretRequest) error {
	return nil
}
func (m *MockClient) DeleteRepositorySecret(ctx context.Context, repository, secretName string) error {
	return nil
}
