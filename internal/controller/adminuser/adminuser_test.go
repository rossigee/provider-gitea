...
func (m *MockClient) CreateOrganizationSecret(ctx context.Context, orgName, secretName string, req *clients.CreateOrganizationSecretRequest) error { return nil }
func (m *MockClient) UpdateOrganizationSecret(ctx context.Context, orgName, secretName string, req *clients.CreateOrganizationSecretRequest) error { return nil }
