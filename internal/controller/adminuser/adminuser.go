...
const (
	...
	errGetAdminUser         = "failed to get adminuser"
	errCreateAdminUser      = "failed to create adminuser"
	errUpdateAdminUser      = "failed to update adminuser"
	errDeleteAdminUser      = "failed to delete adminuser"
