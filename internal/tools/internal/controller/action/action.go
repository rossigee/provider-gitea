...
import (
	...
	"github.com/rossigee/provider-gitea/apis/action/v2"
...
func (e *externalClient) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	// TODO: Implement actual observation logic for Action
...
func (e *externalClient) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	...
	// TODO: Implement creation logic for Action
	externalID := cr.GetName()
	meta.SetExternalName(cr, externalID)

	return managed.ExternalCreation{}, errors.New("Action controller not yet fully implemented")
}
...
func (e *externalClient) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	...
	// TODO: Implement update logic for Action
	return managed.ExternalUpdate{}, errors.New("Action controller not yet fully implemented")
}
...
func (e *externalClient) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	...
	// TODO: Implement deletion logic for Action
	return managed.ExternalDelete{}, errors.New("Action controller not yet fully implemented")
}
