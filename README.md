...
- **Version**: v0.9.0 (v2-only provider framework)
...
- **Registry**: `ghcr.io/rossigee/provider-gitea:v0.9.0`
...
kubectl crossplane install provider ghcr.io/rossigee/provider-gitea:v0.9.0
```
