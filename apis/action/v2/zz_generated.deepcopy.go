...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ActionLastRun) DeepCopyInto(out *ActionLastRun) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(int64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActionLastRun.
func (in *ActionLastRun) DeepCopy() *ActionLastRun {
	if in == nil {
		return nil
	}
	out := new(ActionLastRun)
	in.DeepCopyInto(out)
	return out
}
