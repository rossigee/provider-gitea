...
type RepositorySecret struct {
	...
	Spec   RepositorySecretSpec   `json:"spec,omitempty"`
...
func (r *RepositorySecret) SetConditions(c ...xpv1.Condition) {
	r.Status.SetConditions(c...)
}

// GetManagementPolicies returns the management policies for this resource.
func (r *RepositorySecret) GetManagementPolicies() xpv1.ManagementPolicies {
...
func (r *RepositorySecret) SetProviderConfigReference(p *xpv1.ProviderConfigReference) {
	r.Spec.ProviderConfigReference = p
}

// GetWriteConnectionSecretToReference of this RepositorySecret.
func (r *RepositorySecret) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
