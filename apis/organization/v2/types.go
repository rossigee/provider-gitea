...
func (r *Organization) SetConditions(c ...xpv1.Condition) {
	r.Status.SetConditions(c...)
}

// GetManagementPolicies returns the management policies for this resource.
func (r *Organization) GetManagementPolicies() xpv1.ManagementPolicies {
...
func (r *Organization) SetProviderConfigReference(p *xpv1.ProviderConfigReference) {
	r.Spec.ProviderConfigReference = p
}

// GetWriteConnectionSecretToReference of this Organization.
func (r *Organization) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
