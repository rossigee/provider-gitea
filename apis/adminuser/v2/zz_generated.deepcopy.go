...
func (in *AdminUserObservation) DeepCopyInto(out *AdminUserObservation) {
	*out = *in
	...
	if in.UserStats != nil {
		in, out := &in.UserStats, &out.UserStats
		*out = new(AdminUserStats)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdminUserStats) DeepCopyInto(out *AdminUserStats) {
	*out = *in
	...
	if in.TotalOrganizations != nil {
		in, out := &in.TotalOrganizations, &out.TotalOrganizations
		*out = new(int64)
		**out = **in
	}
	if in.TotalRepositories != nil {
		in, out := &in.TotalRepositories, &out.TotalRepositories
		*out = new(int64)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdminUserStats.
func (in *AdminUserStats) DeepCopy() *AdminUserStats {
	if in == nil {
		return nil
	}
	out := new(AdminUserStats)
