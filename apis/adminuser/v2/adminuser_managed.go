...
// AdminUser: the ProviderConfig + connection-secret accessors. Without
...
func (mg *AdminUser) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// SetProviderConfigReference of this AdminUser.
func (mg *AdminUser) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// GetWriteConnectionSecretToReference of this AdminUser.
func (mg *AdminUser) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}

// SetWriteConnectionSecretToReference of this AdminUser.
func (mg *AdminUser) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
