...
func (r *OrganizationSecret) SetProviderConfigReference(p *xpv1.ProviderConfigReference) {
	r.Spec.ProviderConfigReference = p
}

// GetWriteConnectionSecretToReference of this OrganizationSecret.
func (r *OrganizationSecret) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
	return r.Spec.WriteConnectionSecretToReference
}

// SetWriteConnectionSecretToReference of this OrganizationSecret.
func (r *OrganizationSecret) SetWriteConnectionSecretToReference(p *xpv1.LocalSecretReference) {
