...
func (r *AccessToken) SetConditions(c ...xpv1.Condition) {
	r.Status.SetConditions(c...)
}

// GetManagementPolicies returns the management policies for this resource.
func (r *AccessToken) GetManagementPolicies() xpv1.ManagementPolicies {
...
func (r *AccessToken) SetProviderConfigReference(p *xpv1.ProviderConfigReference) {
	r.Spec.ProviderConfigReference = p
}

// GetWriteConnectionSecretToReference of this AccessToken.
func (r *AccessToken) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
