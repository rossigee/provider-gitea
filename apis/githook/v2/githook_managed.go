...
// GitHook: the ProviderConfig + connection-secret accessors. Without
...
func (mg *GitHook) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// SetProviderConfigReference of this GitHook.
func (mg *GitHook) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// GetWriteConnectionSecretToReference of this GitHook.
func (mg *GitHook) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}

// SetWriteConnectionSecretToReference of this GitHook.
func (mg *GitHook) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
