...
func (in *RepositoryCollaboratorObservation) DeepCopyInto(out *RepositoryCollaboratorObservation) {
	*out = *in
	...
	if in.Permissions != nil {
		...
		*out = new(RepositoryCollaboratorPermissions)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RepositoryCollaboratorPermissions) DeepCopyInto(out *RepositoryCollaboratorPermissions) {
	*out = *in
	if in.Admin != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RepositoryCollaboratorPermissions.
func (in *RepositoryCollaboratorPermissions) DeepCopy() *RepositoryCollaboratorPermissions {
	if in == nil {
		return nil
	}
	out := new(RepositoryCollaboratorPermissions)
