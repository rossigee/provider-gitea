...
// UserKey: the ProviderConfig + connection-secret accessors. Without
...
func (mg *UserKey) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// SetProviderConfigReference of this UserKey.
func (mg *UserKey) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// GetWriteConnectionSecretToReference of this UserKey.
func (mg *UserKey) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}

// SetWriteConnectionSecretToReference of this UserKey.
func (mg *UserKey) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
