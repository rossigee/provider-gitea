...
func (r *UserKey) SetConditions(c ...xpv1.Condition) {
	r.Status.SetConditions(c...)
}

// GetManagementPolicies returns the management policies for this resource.
func (r *UserKey) GetManagementPolicies() xpv1.ManagementPolicies {
...
func (r *UserKey) SetProviderConfigReference(p *xpv1.ProviderConfigReference) {
	r.Spec.ProviderConfigReference = p
}

// GetWriteConnectionSecretToReference of this UserKey.
func (r *UserKey) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
	return r.Spec.WriteConnectionSecretToReference
}

// SetWriteConnectionSecretToReference of this UserKey.
func (r *UserKey) SetWriteConnectionSecretToReference(p *xpv1.LocalSecretReference) {
