...
func (r *Label) SetConditions(c ...xpv1.Condition) {
	r.Status.SetConditions(c...)
}

// GetManagementPolicies returns the management policies for this resource.
func (r *Label) GetManagementPolicies() xpv1.ManagementPolicies {
...
func (r *Label) SetProviderConfigReference(p *xpv1.ProviderConfigReference) {
	r.Spec.ProviderConfigReference = p
}

// GetWriteConnectionSecretToReference of this Label.
func (r *Label) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
